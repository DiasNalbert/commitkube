      ...
      <div className="glass-card p-6 border-l-4 border-l-[#0052CC]">
        ...
        <div className="mb-4 p-3 rounded bg-blue-500/10 border border-blue-500/30 text-sm space-y-2">
          ...
          <ol className="list-decimal list-inside space-y-1 text-zinc-300">
            <li>Go to <a href="https://bitbucket.org/account/settings/app-passwords/new" target="_blank" rel="noreferrer" className="text-blue-400 underline">bitbucket.org → Personal settings → App passwords</a></li>
